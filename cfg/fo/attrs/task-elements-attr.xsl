...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:attribute-set name="task__content" use-attribute-sets="section__content"> </xsl:attribute-set>
    ...
    <xsl:attribute-set name="result" use-attribute-sets="example"> </xsl:attribute-set>

    <!-- Formats paragraph following  Task Result title   -->
    <xsl:attribute-set name="result__content" use-attribute-sets="example__content"> </xsl:attribute-set>
    ...
    <xsl:attribute-set name="task.example__content" use-attribute-sets="example__content"> </xsl:attribute-set>
    ...
    <xsl:attribute-set name="task.result__content" use-attribute-sets="example__content"> </xsl:attribute-set>
